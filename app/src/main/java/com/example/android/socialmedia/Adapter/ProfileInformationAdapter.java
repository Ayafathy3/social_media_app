...
public class ProfileInformationAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ProfileInformationAdapter(ArrayList<Post> arrayList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == 1) {
            ...
            return new ProfileInformationAdapter.profileData(view);
        } else {
            View view = LayoutInflater.from(context).inflate(R.layout.home_item, parent, false);
            context = parent.getContext();
            return new ProfileInformationAdapter.profilePosts(view);
        }
                ...
                firebaseFirestore.collection("Users").document(userId).get().addOnCompleteListener(new OnCompleteListener<DocumentSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Glide.with(context).load(userImage).into(viewHolder.profileImage);
